        ...
        <div className="mx-auto rounded-lg shadow-lg p-8 md:p-12">
          ...
          <div className="bg-blue-50 border-l-4 border-blue-400 p-6 mb-8 rounded">
            ...
            <p className="text-blue-700 leading-relaxed">
              <strong>This is a demonstration project created for portfolio purposes.</strong> Madhesh Matters is a sample digital news platform developed to showcase technical skills in modern web development. It is not a commercial service and should not be used as a real news platform.
            </p>
          </div>
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <p className="text-gray-700 mb-4 leading-relaxed">
              Madhesh Matters is a portfolio project that demonstrates:
            </p>
